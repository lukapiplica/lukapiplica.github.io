...
<p align="center">
  <b>👋 Pop! Linux configuration files 👋</b>
</p>
...
2. Installation of **BSPWM Tilling Window Manager**:
...
3. Installation of **keyboard deamon**:
...
6. Installation of **Rofi**: 

   ```shell
   sudo apt install rofi
   ```

7. Installation of **Alacritty** terminal: 
...
9. Setting up an alacritty theme: 
...
14. Installation of **Powerlevel0k**:
...
17. Installation of **Slim i Slimlock**:
   ...
   + If we get a menu, we have to choose Slim as an option. 
...
- We have successfully achieved the look of this operating system; now, we are installing several programs from the pictures.
   ...
   2. Installation of **CAVA Audio Visualizer**:
   ...
   11. Installation of **Minimal Functional Fox**:

         ```shell
         sh -c "$(curl -fsSL https://raw.githubusercontent.com/mut-ex/minimal-functional-fox/master/install.sh)"
         ```
   
   12. Set up a Firefox theme:

         ```shell
         cp -r ~/Downloads/dots/.firefoxthemes ~/
         ```

   + Then open `Firefox` and go to `prefrences`, then to `Home` and where it says `Homepage and new windows` we select `Custom URLs ...`, below we write this:
...
- Installation of GTK Theme: 
   ...
   1. Installation of **Lxappearance**:
   ...
   2. Installation of **[Nordic Dark](https://www.gnome-look.org/p/1267246/)** theme:

      + Download the zip file, extract it and insert it in Lxappearance.

   
   3. Installation of **[Flattery Dark](https://www.gnome-look.org/s/Gnome/p/1332404)** theme for icons:

      + Download the zip file, extract it and insert it in Lxappearance.

   
   4. Installation of **[Oreo Blue](https://www.gnome-look.org/s/Gnome/p/1360254/)** cursor theme:
...
| <kbd>super + ctrl + [strelice]</kbd> | Moves the float windows |
