...
2. Installation of **MVT-a**:
   ...
   + Installation of MVT-a:
     ...
     Then we have to download MVT from GitHub: we do this by typing this command in the terminal:
     ...
     ```
     Note **USERNAME** that you need to change depending on the username on Linux.
...
## Digital forensics on Android devices:
   ...
   2. Checking for malicious **SMS messages**:
